path_method_dict = {
    "posts/(?P<post_id>\\d+)/delete/v1/": {
        "DELETE": "delete_post"
    }
}


def posts__post_id__delete_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("fb_post_v2", "posts__post_id__delete_v1_", operations_dict, request, *args, **kwargs)
    return response