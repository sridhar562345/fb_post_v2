...
from fb_post_v2.build.view_environments.comments__comment_id__replies_v1_.get_comment_replies.responses.Status_200.Status_200.Status_200Serializer import Status_200Serializer
...
def get_comment_replies(request, *args, **kwargs):
    args = (request,) + args
    from django_swagger_utils.drf_server.wrappers.view_env_wrapper import view_env_wrapper
    return view_env_wrapper(app_name, "get_comment_replies", group_name, *args, **kwargs)
