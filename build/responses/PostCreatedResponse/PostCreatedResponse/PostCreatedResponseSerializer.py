...
class PostCreatedResponseType(object):
    def __init__(self, post_id=None,  **kwargs):
...
class PostCreatedResponseSerializer(serializers.Serializer):
    post_id = serializers.IntegerField(required=False, allow_null=True)

    def create(self, validated_data):
        return PostCreatedResponseType(**validated_data)
