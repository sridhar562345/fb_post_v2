...
from fb_post_v2.build.serializers.definitions.CommentWithReplies.CommentWithReplies.Schema1.Schema1Serializer import Schema1Serializer
from fb_post_v2.build.serializers.definitions.CommentWithReplies.CommentWithReplies.Schema1.Schema1Serializer import Schema1Type

from django_swagger_utils.drf_server.utils.decorator.deserialize import deserialize

class CommentWithRepliesType(CommentType, Schema1Type):
    def __init__(self, **validated_data):
        CommentType.__init__(self, **validated_data)
        Schema1Type.__init__(self, **validated_data)
        

class CommentWithRepliesSerializer(CommentSerializer, Schema1Serializer):
    def create(self, validated_data):
        ...
        return CommentWithRepliesType(**validated_data)
